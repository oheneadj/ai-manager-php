          ...
          <div class="d-flex">
            ...
            <div class="navbar-brand-box">
              ...
              <a href="index.html" class="logo logo-light">
                ...
                <span class="logo-lg">
                  <img src="assets/images/logo.png" alt="" height="30" /> <span class="text-white"> AI Training Manager</span>
                </span>
              </a>
            </div>
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    <a
                      ...
                      role="button"
                    >
                      <i class="uil-layers me-2"></i>Components
                      <div class="arrow-down"></div>
                    </a>
                    <div
                      class="dropdown-menu"
                  ...
                  <li class="nav-item dropdown">
                    <a
                      ...
                      role="button"
                    >
                      <i class="uil-copy me-2"></i>Extra pages
                      <div class="arrow-down"></div>
                    </a>
                  ...
                  <li class="nav-item dropdown">
                    <a
                      ...
                      role="button"
                    >
                      <i class="uil-window-section me-2"></i>Layouts
                      <div class="arrow-down"></div>
                    </a>
